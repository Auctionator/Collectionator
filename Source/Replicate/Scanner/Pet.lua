CollectionatorReplicatePetScannerFrameMixin = CreateFromMixins(CollectionatorReplicateScannerFrameMixin)

function CollectionatorReplicatePetScannerFrameMixin:OnLoad()
...
function CollectionatorReplicatePetScannerFrameMixin:GetSourceName()
  return "CollectionatorReplicatePetScannerFrameMixin"
end

function CollectionatorReplicatePetScannerFrameMixin:GetItem(index, link, scanInfo)
