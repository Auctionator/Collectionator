...
function CollectionatorSummaryBuyoutDropDownMixin:ShowMenu()
  ...
  MenuUtil.CreateContextMenu(self:GetParent(), function(_, rootDescription)
    ...
    local title = rootDescription:CreateTitle(Collectionator.Utilities.SummaryColorName(self.rowData.itemKeyInfo))
